...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { moeda: @coin.moeda, sigla: @coin.sigla, url_imagem: @coin.url_imagem } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { moeda: @coin.moeda, sigla: @coin.sigla, url_imagem: @coin.url_imagem } }
